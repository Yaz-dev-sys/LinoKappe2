"""
Django settings for LinoKappe project.
...
SECRET_KEY = 'django-insecure-c(21a9me$4w*36#6=q2*ikb_@r^i=xy1=w(0bdsdt7d460r!67'
...
WSGI_APPLICATION = 'LinoKappe.wsgi.application'
